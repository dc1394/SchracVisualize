...
#define SIMPLEVER2
		...
		*/
		...
		/*!
			唯一のコンストラクタ
		*/
		explicit TDXScene(std::shared_ptr<getdata::GetData> const & pgd);
	...
	public:
		...
		*/
		utility::Property<std::shared_ptr<ID3D10InputLayout> const &> const PInputLayout;
	...
	private:
		...
		*/
		...
		/*!
			入力レイアウト インターフェイス
		*/
		std::shared_ptr<ID3D10InputLayout> pInputLayout_;
